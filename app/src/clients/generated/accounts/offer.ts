...
export type Offer = {
  ...
  id: bigint;
  maker: Address;
  mintAddressA: Address;
  mintAddressB: Address;
  mintAddressBWanted: bigint;
  bump: number;
};
...
export type OfferArgs = {
  ...
  mintAddressA: Address;
  mintAddressB: Address;
  mintAddressBWanted: number | bigint;
  bump: number;
};
...
export function getOfferEncoder(): FixedSizeEncoder<OfferArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['mintAddressA', getAddressEncoder()],
      ['mintAddressB', getAddressEncoder()],
      ['mintAddressBWanted', getU64Encoder()],
      ['bump', getU8Encoder()],
    ]),
...
export function getOfferDecoder(): FixedSizeDecoder<Offer> {
  return getStructDecoder([
    ...
    ['mintAddressA', getAddressDecoder()],
    ['mintAddressB', getAddressDecoder()],
    ['mintAddressBWanted', getU64Decoder()],
    ['bump', getU8Decoder()],
  ]);
}
